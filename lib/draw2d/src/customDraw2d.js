...
draw2d.CustomCanvas = draw2d.Canvas.extend({
     ...
     * selectedConfigPanel needs to register itself to globalEventAgent
     */
	_selectEventHandler: function(emitter, event){
		if(globalEventAgent.isRegistered('selectedConfigPanel'))
		{
			if(event.figure!==null && event.figure.name === 'Connection')
			{
				...
				globalEventAgent.makeEvent("selectedConfigPanel", "canvasSelect", {
		...
		{
			console.log("selectedConfigPanel hasn't registered itself to globalEventAgent.");
		}
	},
	...
	/**
     * @method
     * msgPanel needs to register itself to globalEventAgent
     * @param {String} msg
     */
	sendMsgToMsgPanel: function(msg){
		if(globalEventAgent.isRegistered('msgPanel'))
		{
		...
		{
			console.log("msgPanel hasn't registered itself to globalEventAgent.");
		}
	},
